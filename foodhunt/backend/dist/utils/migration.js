...
exports.migrateFoodItems = void 0;
...
const migrateFoodItems = async () => {
    try {
        ...
        const itemsNeedingMigration = await FoodItem_1.FoodItem.find({
            $or: [
                { stock: { $exists: false } },
        ...
        for (const item of itemsNeedingMigration) {
            ...
            await FoodItem_1.FoodItem.updateOne({ _id: item._id }, {
                $set: {
                    stock: item.stock || 0,
...
exports.migrateFoodItems = migrateFoodItems;
